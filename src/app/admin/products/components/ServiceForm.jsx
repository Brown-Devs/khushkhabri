...
import Step4SeoDetails from './steps/Step4SeoDetails';
...
export default function ServiceForm({ defaultValues, onSubmit, loading, error }) {
    const methods = useForm({
        ...
        defaultValues: {
            ...
            tags: [],
            status: true,
            subServiceSectionHeading: '',
            subServiceSectionTagLine: '',
            subServices: [{ image: '', icon: '', name: '', content: '' }],
            whyChooseUs: [{ icon: '', title: '', content: '' }],
            faqs: [{ question: '', ans: '' }],
            serviceBigDescription: [{ name: '', title: '', content: '' }],
            seoTitle: '',
            seoDescription: '',
            seoKeywords: '',
            ...defaultValues,
    ...
    const stepFieldsMap = [
        ['name', 'slug', 'shortDescription', 'images', 'categories', 'status', 'icon', 'headerLabel', 'headerImage', 'subServiceSectionHeading', 'subServiceSectionTagLine', 'subServices'],
        ['whyChooseUs', 'faqs', 'contactLine'],
