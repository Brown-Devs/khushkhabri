...
export default function Step1BasicDetails() {
    ...
    const [openSingleImageDialog, setOpenSingleImageDialog] = useState(false);
    ...
    return (
        <div className='space-y-2'>
                    ...
                    render={({ field }) => (
                        ...
                        >
                            ...
                            <FormControl>
                                <Input
                                    type='color'
                                    placeholder="Service Page Theme Color"
                                    {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem className="">
                            ...
                            <FormControl>
                                <Textarea placeholder="Description for header section…" rows={2} {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input placeholder="Header Bottom Label" {...field} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
                    ...
                    <div className="flex flex-col gap-3">
                        {!headerImage && (
                            <div
                                ...
                                onClick={() => setOpenSingleImageDialog(true)}
                            >
                        ...
                        {headerImage && (
                            <div
                            // className="grid grid-cols-3 xl:grid-cols-5 gap-3"
                            >
                                <div
                                    className="relative border rounded-lg overflow-hidden group aspect-video"
                                >
                                    <Image
                                        src={headerImage}
                                        alt={`header-image`}
                        ...
                        {errors.headerImage && (
                            <p className="text-red-500 text-sm mt-1">{errors.headerImage.message}</p>
                        )}
                    </div>
                </div>
            ...
            {/* Sub Secvice Section Heading */}
            <div className=' bg-white border rounded-xl p-7'>
                <FormField
                    control={control}
                    name="subServiceSectionHeading"
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel className={'text-primary font-bold text-md'}>Sub Service Section - Heading*</FormLabel>
                            <FormControl>
                                <Input placeholder="What We Offer Under Website Development?" {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
            ...
            {/* Sub Secvice Section Tag Line */}
            <div className=' bg-white border rounded-xl p-7'>
                <FormField
                    control={control}
                    name="subServiceSectionTagLine"
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel className={'text-primary font-bold text-md'}>Sub Service Section - Tag line*</FormLabel>
                            <FormControl>
                                <Input placeholder="What We Offer Under Website Development?" {...field} />
                            </FormControl>
                            <FormMessage />
            ...
            <div className="space-y-6 bg-white border rounded-xl p-7">
                <Label className={'font-bold text-primary text-xl'}>Add Sub Services</Label>

                {/* Add Sub Service Card Button */}
                <Button
                    type="button"
                    variant="outline"
                    ...
                    {variantFields.map((field, index) => (
                        <Card key={field.id} className="p-4 relative shadow-none border border-gray-300 bg-gray-100">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="">
                                    ...
                                    <div className="flex flex-col gap-2 mt-3">
                                        {watch(`subServices.${index}.image`) && (
                                            <div className="border rounded-md w-auto h-auto overflow-hidden aspect-video">
                                                <Image
                                                    src={watch(`subServices.${index}.image`)}
                                                    alt="Selected Image"
                                                    height={300}
                                                    width={500}
                                        ...
                                        >
                                            {watch(`subServices.${index}.image`) ? 'Change Image' : 'Select Image'}
                                        </Button>
                                    </div>
                                </div>
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormControl>
                                                    <Input placeholder="Admin Panel Development" {...field} className={'bg-white'} />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                ...
                                <div className="">
                                    <FormField
                                        control={control}
                                        name={`subServices.${index}.content`}
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormControl>
                                                    <Textarea
                                                        className={'bg-white'}
                                                        placeholder="Robust Admin Panel.." rows={2} {...field} />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormControl>
                                                    <Textarea
                                                        rows={4}
                                                        placeholder="SVG Icon Code" {...field}
                                                        className="h-28 resize-none overflow-y-auto bg-white"
                                                    />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                            ...
                            <ImageSelector
                                ...
                                setImage={(url) => {
                                    setValue(`subServices.${index}.image`, url);
            ...
            <ImageSelector
                open={openSingleImageDialog}
                onOpenChange={setOpenSingleImageDialog}
                setImage={(imageUrl) => {
