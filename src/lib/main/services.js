...
export async function getActiveServices() {
  try {
    ...
    return JSON.parse(JSON.stringify(activeServices));
  } catch (error) {
    console.error("Error in getting active Services: ", error);
    return null;
  }
}
...
export async function getActiveCategories() {
  try {
    ...
    console.error("Error in getting active Categories: ", error);
    return null;
  }
}
